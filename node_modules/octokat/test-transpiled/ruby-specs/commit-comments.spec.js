...
describe('Commit Comments', function () {
  ...
  it('returns a list of all commit comments', function () {
    return client.repos('sferik/rails_admin').comments.fetch().then(function () {
      return true;
    });
  });
  ...
  context('with commit comment', function () {
    ...
    it('creates a commit comment', function () {
      return expect(_this.commit_comment.user.login).to.not.be.null;
    });
    ...
    it('deletes a commit comment', function () {
      return _this.commit_comment.remove();
    });
  });
});
