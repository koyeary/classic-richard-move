...
describe(GH + ' = new Octokat({token: ...})', function () {
  ...
  describe(REPO + ' = ' + GH + '.repos(OWNER, NAME)', function () {
    ...
    describe('Collaborator changes', function () {
      ...
      it('tests membership', function () {
        return trapFail(STATE[REPO].collaborators.contains('random-user-name')).then(function (v) {
          return expect(v).to.be.false;
        });
      });

      it('adds and removes a collaborator', function () {
  ...
  describe(USER + ' = ' + GH + '.users(USERNAME)', function () {
    ...
    it('camelCases URL fields that are not templated (ie ' + USER + '.avatarUrl)', function () {
  ...
  describe(GIST + ' = ' + GH + '.gist(GIST_ID)', function () {
    ...
    it('can be .starred.add() and .starred.remove()', function () {
